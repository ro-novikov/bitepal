      ...
      messages: [
        {
          ...
          content:
            ...
            'Return JSON with exactly two keys: "quote" (a short 1-sentence paraphrase of their why, wrapped in quotes, first person) ' +
            'and "response" (2-3 warm sentences acknowledging their motivation and how BitePal will keep it front and center). ' +
